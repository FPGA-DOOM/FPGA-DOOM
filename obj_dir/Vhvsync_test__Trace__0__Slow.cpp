...
VL_ATTR_COLD void Vhvsync_test___024root__trace_init_sub__TOP__0(Vhvsync_test___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhvsync_test___024root__trace_init_sub__TOP__0\n"); );
    ...
    tracep->declBus(c+12,0,"rgb",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+13,0,"out_hpos",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 9,0);
    tracep->declBus(c+14,0,"out_vpos",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 9,0);
    tracep->popPrefix();
    tracep->pushPrefix("test_hvsync_top", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBit(c+8,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+9,0,"reset",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+10,0,"hsync",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+11,0,"vsync",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+3,0,"r",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+6,0,"hmaxxed",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+7,0,"vmaxxed",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    tracep->popPrefix();
}

VL_ATTR_COLD void Vhvsync_test___024root__trace_init_top(Vhvsync_test___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhvsync_test___024root__trace_init_top\n"); );
    Vhvsync_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vhvsync_test___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vhvsync_test___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vhvsync_test___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vhvsync_test___024root__trace_register(Vhvsync_test___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhvsync_test___024root__trace_register\n"); );
    Vhvsync_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vhvsync_test___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vhvsync_test___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vhvsync_test___024root__trace_chg_0, 0, vlSelf);
    tracep->addCleanupCb(&Vhvsync_test___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vhvsync_test___024root__trace_const_0_sub_0(Vhvsync_test___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vhvsync_test___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhvsync_test___024root__trace_const_0\n"); );
    // Body
    Vhvsync_test___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vhvsync_test___024root*>(voidSelf);
    Vhvsync_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vhvsync_test___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vhvsync_test___024root__trace_const_0_sub_0(Vhvsync_test___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhvsync_test___024root__trace_const_0_sub_0\n"); );
    Vhvsync_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vhvsync_test___024root__trace_full_0_sub_0(Vhvsync_test___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vhvsync_test___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhvsync_test___024root__trace_full_0\n"); );
    // Body
    Vhvsync_test___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vhvsync_test___024root*>(voidSelf);
    Vhvsync_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vhvsync_test___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vhvsync_test___024root__trace_full_0_sub_0(Vhvsync_test___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhvsync_test___024root__trace_full_0_sub_0\n"); );
    Vhvsync_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    bufp->fullBit(oldp+0,(vlSelfRef.test_hvsync_top__DOT__display_on));
    bufp->fullSData(oldp+1,(vlSelfRef.test_hvsync_top__DOT__hpos),10);
    bufp->fullSData(oldp+2,(vlSelfRef.test_hvsync_top__DOT__vpos),10);
    bufp->fullBit(oldp+3,(((IData)(vlSelfRef.test_hvsync_top__DOT__display_on) 
                           & ((0U == (7U & (IData)(vlSelfRef.test_hvsync_top__DOT__hpos))) 
                              | (0U == (7U & (IData)(vlSelfRef.test_hvsync_top__DOT__vpos)))))));
    bufp->fullBit(oldp+4,(((IData)(vlSelfRef.test_hvsync_top__DOT__display_on) 
                           & ((IData)(vlSelfRef.test_hvsync_top__DOT__vpos) 
                              >> 4U))));
    bufp->fullBit(oldp+5,(((IData)(vlSelfRef.test_hvsync_top__DOT__display_on) 
                           & ((IData)(vlSelfRef.test_hvsync_top__DOT__hpos) 
                              >> 4U))));
    bufp->fullBit(oldp+6,((0x031fU == (IData)(vlSelfRef.test_hvsync_top__DOT__hpos))));
    bufp->fullBit(oldp+7,((0x020cU == (IData)(vlSelfRef.test_hvsync_top__DOT__vpos))));
    bufp->fullBit(oldp+8,(vlSelfRef.clk));
    bufp->fullBit(oldp+9,(vlSelfRef.reset));
    bufp->fullBit(oldp+10,(vlSelfRef.hsync));
    bufp->fullBit(oldp+11,(vlSelfRef.vsync));
    bufp->fullCData(oldp+12,(vlSelfRef.rgb),3);
    bufp->fullSData(oldp+13,(vlSelfRef.out_hpos),10);
    bufp->fullSData(oldp+14,(vlSelfRef.out_vpos),10);
}
